...
Файл `mp3.php` использовался для воспроизведения аудио из Telegram и http ВК

Также некоторые проигрыватели на Linux не восспроизводили аудио по https и у VK была пренудительная переадресация на https
